        ...
        <head>
            ...
            <style type="text/css">
                {literal}
					...
					.group-container > .row-fluid > .col-md-9{
						min-height: 162px;
					}
					.group-heading input{
						...
						<form id="SystemSetup" class="form" method="POST" action="index.php?module=Users&action=SystemSetupSave">
							...
							{foreach from=$PACKAGES_LIST key=PACKAGE_NAME item=PACKAGE_INFO}
								{if $COUNTER eq 0 || $COUNTER mod 2 eq 1}
									<div class="row-fluid">
									{/if}
									<div class="group-container {if $COUNTER eq 0} col-md-12 selectedContainer js-basePack {else} col-md-6 {/if}">
										<div class="module_list"><a> View Modules </a></div>
										<div class="row-fluid">
											<div class="{if $COUNTER eq 0} col-md-2 {else} col-md-3 {/if}">
												<img src="layouts/vlayout/skins/images/{$PACKAGE_INFO.imageName}" alt="Vtiger Logo"/>
											</div>
											<div class="{if $COUNTER eq 0} col-md-10 {else} col-md-9 {/if}">
