...
<section class="panel">
	<div class="panel-body">
		...
		<div class="clearfix form-actions">
			<a class="cancelLink cursorPointer pull-right horizontalLeftSpacing" style="padding: 8px;">{vtranslate('LBL_CANCEL', $MODULE)}</a>
			<button class="btn addButton select pull-right btn-primary">
