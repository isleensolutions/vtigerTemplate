					...
					<tr data-currency-id={$price.curname}>
						...
						<td>
							<span class="row-fluid">
								...
								<span class="col-md-2"><input type="checkbox" name="cur_{$price.curid}_check" id="cur_{$price.curid}_check" class="small pull-right enableCurrency" {$check_value}></span>
							</span>
						</td>
						<td>
							<div class="row-fluid">
						...
						<td>
							<div class="row-fluid">
								<input readonly="" type="text" size="10" class="col-md-9 conversionRate" name="cur_conv_rate{$price.curid}" value="{$price.conversionrate}">
							</div>
						</td>
						<td>
							<div class="row-fluid">
