...
<table width="100%" cellspacing="0" cellpadding="2" class="importContents padding1per">
	...
	<tr>
		<td>&nbsp;</td>
		<td>
			<div id="savedMapsContainer" class="textAlignRight pull-right m-bot15">
	...
	<tr>
		...
		<td>
			...
			<table width="100%" cellspacing="0" cellpadding="2" class="listRow table table-inbox table-condensed listViewEntriesTable">
				<thead>
	...
	<tr>
		<td>&nbsp;</td>
		<td class="pull-right custommapping" align="right">
			<input type="checkbox" name="save_map" id="save_map" class="font-x-small" />
			<span>{'LBL_SAVE_AS_CUSTOM_MAPPING'|@vtranslate:$MODULE}</span>&nbsp; : &nbsp;
			<input type="text" name="save_map_as" id="save_map_as" class="font-x-small form-control" />
		</td>
		<td>&nbsp;</td>
	</tr>
</table>
