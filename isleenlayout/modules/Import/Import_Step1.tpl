 ...
 ********************************************************************************/
-->*}
<table  class="m-bot15" width="100%" cellspacing="0" cellpadding="2">
	<tr>
			...
			<div class="controls">
				<div class="fileupload fileupload-new" data-provides="fileupload">
					<span class="btn btn-white btn-file">
						...
						<input class="default" type="file" name="import_file" id="import_file" onchange="ImportJs.checkFileType()"/>
					</span>
					<span class="fileupload-preview" style="margin-left:5px;"></span>
					<a class="close fileupload-exists" style="float: none; margin-left:5px;" data-dismiss="fileupload" href="#"></a>
				</div>
			</div>
		</td>
	</tr>
