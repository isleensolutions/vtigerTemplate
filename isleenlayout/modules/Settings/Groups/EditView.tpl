	...
	<form name="EditGroup" action="index.php" method="post" id="EditView" class="form-horizontal">
		...
		<div class="control-group FloatWidth m-bot15">
			...
			<div class="controls col-md-6">
				<input class="input-large form-control" name="groupname" value="{$RECORD_MODEL->getName()}" data-validation-engine="validate[required]">
			</div>
		</div>
		<div class="control-group FloatWidth m-bot15">
			<span class="control-label col-md-3">
			...
			<div class="controls col-md-6">
				<input class="input-large form-control" name="description" id="description" value="{$RECORD_MODEL->getDescription()}" />
			</div>
		</div>
		<div class="control-group FloatWidth m-bot15">
			<span class="control-label col-md-3">
			...
			<div class="controls col-md-6">
				<div class="row-fluid">
					<span class="FloatWidth">
						{assign var="GROUP_MEMBERS" value=$RECORD_MODEL->getMembers()}
						<select id="memberList" class="row-fluid members form-control" multiple="true" name="members[]" data-placeholder="{vtranslate('LBL_ADD_USERS_ROLES', $QUALIFIED_MODULE)}" data-validation-engine="validate[required]">
		...
		<span class="FloatWidth">
						<span class="pull-right groupMembersColors">
							<ul class="liStyleNone col-md-12">
