...
{strip}
    ...
    {else}
	<div class="row-fluid">
		<label class="fieldLabel col-md-4"><strong>{vtranslate('LBL_SELECT_PICKLIST_IN',$QUALIFIED_MODULE)}&nbsp;{vtranslate($SELECTED_MODULE_NAME,$QUALIFIED_MODULE)}</strong></label>
