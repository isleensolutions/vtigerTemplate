...
{strip}
	<div class="listViewPageDiv">
		...
		<div class="listViewContentDiv" id="listViewContents">
			<div class="row-fluid marginbottom10px FloatWidth">
				<label class="fieldLabel col-md-4"><strong>{vtranslate('LBL_SELECT_MODULE',$QUALIFIED_MODULE)} </strong></label>
				<div class="col-md-5 fieldValue">
			...
			<div id="modulePickListContainer" class="FloatWidth m-bot15">
				{include file="ModulePickListDetail.tpl"|@vtemplate_path:$QUALIFIED_MODULE}
			</div>

			<div id="modulePickListValuesContainer" class="FloatWidth">
