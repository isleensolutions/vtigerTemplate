...
-->*}
{strip}
<div class='modal modelContainer basicAssignValueToRoleView'>
	...
	<form id="assignValueToRoleForm" class="form-horizontal" method="post" action="index.php">
		...
		<div class="modal-body tabbable marginLeftRight20px">
			...
			{if $SELECTED_PICKLIST_FIELDMODEL->isRoleBased()}
				<div class="control-group FloatWidth m-bot15">	
					<div class="control-label col-md-6"><span class="redColor">*</span>{vtranslate('LBL_ASSIGN_TO_ROLE',$QUALIFIED_MODULE)}</div>
					<div class="controls col-md-6">
