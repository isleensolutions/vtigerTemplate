										...
										{foreach item=LINK_MODEL from=$MODULE_MODEL->getMappingLinks()}
											<div class="pull-right actions">
												<span class="actionImages">
													<a><i title="{vtranslate($LINK_MODEL->getLabel(), $MODULE)}" class="fa fa-trash-o deleteMapping"></i></a>
												</span>
											</div>
										{/foreach}
									{/if}
			...
			<div class="row-fluid">
				<span class="col-md-4">
					<button id="addMapping" class="btn addButton" type="button">
						<i class="fa fa-plus icon-white"></i>&nbsp;<strong>{vtranslate('LBL_ADD_MAPPING', $QUALIFIED_MODULE)}</strong>
					</button>
				</span>
				<span class="col-md-8">
					<span class="pull-right">
