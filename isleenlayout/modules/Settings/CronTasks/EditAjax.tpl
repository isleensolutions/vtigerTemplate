...
-->*}
{strip}
<div class="modal modelContainer CronSchedule" style="height: 380px;overflow: hidden;">	
	...
	<form class="form-horizontal" id="cronJobSaveAjax" method="post" action="index.php">
		...
		<div class="modal-body tabbable marginLeftRight20px">
			<div class="control-group FloatWidth m-bot15">
				<div class="control-label col-md-6">{vtranslate('LBL_STATUS',$QUALIFIED_MODULE)}</div>
			...
			<div class="control-group FloatWidth m-bot15">
				...
				<div class="controls row-fluid col-md-6 sendRE">
					...
					{/if}
					<input type="text" class="form-control" value="{$FIELD_VALUE}" data-validation-engine="validate[required,funcCall[Vtiger_WholeNumberGreaterThanZero_Validator_Js.invokeValidation]]" id="frequencyValue" style="width:30%;float: left;"/>
			...
			<div class="alert alert-info col-md-12">{vtranslate($RECORD_MODEL->get('description'),$QUALIFIED_MODULE)}</div>
		</div>
