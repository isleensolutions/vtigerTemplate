            ...
            <div class="modal-body marginLeftRight20px">
                <div class="row-fluid">
                    <div class="control-group  ">
                        <label class="control-label col-md-5 m-bot15">{vtranslate($MODULE_MODEL->get('name'), $MODULE)}&nbsp;{vtranslate('LBL_OF', $MODULE)}</label>
                        <div class="controls col-md-7 m-bot15">
                    ...
                    <div class="control-group  ">
                        <label class="control-label col-md-5 m-bot15">{vtranslate('LBL_CAN_ACCESSED_BY', $QUALIFIED_MODULE)}</label>
                            <div class="controls col-md-7 m-bot15">
                    ...
                    <div class="control-group ">
                        <label class="control-label col-md-5 m-bot15">{vtranslate('LBL_WITH_PERMISSIONS', $QUALIFIED_MODULE)}</label>
                        <div class="controls col-md-7 m-bot15">
                            <label class="radio">
