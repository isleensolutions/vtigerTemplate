{strip}
	...
	<div class="detailViewContainer">
		<div class="detailViewTitle webform-detailViewTitle">
					
					<aside class="webform-aside">
						<div class="detail-summary-head details-webform-summary-head">
