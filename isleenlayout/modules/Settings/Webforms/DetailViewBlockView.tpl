{strip}
	...
	<section class="panel DetailViewRemoveBorder webform-section-panel">
		...
		{assign var=COUNTER value=0}
			...
			<tr class="FloatWidth">
				...
				{assign var=COUNTER value=$COUNTER+1}
				{/if}
				<td class="fieldLabel {$WIDTHTYPE} form-horizontal  col-md-2" id="{$MODULE}_detailView_fieldLabel_{$FIELD_MODEL->getName()}">
				...
				<td class="fieldValue {$WIDTHTYPE}  col-md-4" id="{$MODULE}_detailView_fieldValue_{$FIELD_MODEL->getName()}" {if $FIELD_MODEL->get('uitype') eq '19' or $FIELD_MODEL->get('uitype') eq '20'} colspan="3" {assign var=COUNTER value=$COUNTER+1} {/if}>
