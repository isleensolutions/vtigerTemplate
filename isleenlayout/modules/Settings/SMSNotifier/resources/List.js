	...
	registerProviderTypeChangeEvent : function(form) {
		...
		form.find('.providerType').change(function(e) {
			...
			jQuery.each(fieldDetails, function(index, field) {
				var newFieldEle = jQuery('<div class="control-group form-group"><span class="control-label  col-md-3"><strong>'+field+'</strong></span><div class="controls col-md-9 sms_notifier_controls">\n\
					<input type="text" name="'+field+'" class="col-md-3 form-control" value="" /></div></div>');
