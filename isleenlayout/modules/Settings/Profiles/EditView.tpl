	...
	<form id="EditView" name="EditProfile" action="index.php" method="post" class="form-horizontal">
		...
		<div class="row-fluid">
			<div class="row-fluid FloatWidth m-bot15">
				<label class="fieldLabel col-md-3"><span class="redColor">*</span><strong>{vtranslate('LBL_PROFILE_NAME', $QUALIFIED_MODULE)}: </strong></label>
				<div class="col-md-6">
			...
			<div class="row-fluid FloatWidth m-bot15">
				<label class="fieldLabel col-md-3"><strong>{vtranslate('LBL_DESCRIPTION', $QUALIFIED_MODULE)}:</strong></label>
				<div class="col-md-8">
            ...
            <div class="summaryWidgetContainer" style="padding: 1%;border: 1px solid #DDDDDD;">
			...
			<div class="row-fluid">
				...
				<table class="table table-striped table-hover table-bordered FloatWidth profilesEditView">
					<thead>
						...
						{foreach from=$PROFILE_MODULES key=TABID item=PROFILE_MODULE}
								...
								<td style="border-left: 1px solid #DDD !important;">
									{if $PROFILE_MODULE->getFields()}
										<div class="row-fluid">
											...
											<span class="col-md-4"><button type="button" data-handlerfor="fields" data-togglehandler="{$TABID}-fields" class="btn btn-mini" style="padding: 0 20px">
							...
							<tr class="hide">
								<td colspan="6" class="row-fluid" style="padding-left: 5%;padding-right: 5%">
									<div class="row-fluid  FloatWidth" data-togglecontent="{$TABID}-fields">
									{if $PROFILE_MODULE->getFields()}
										...
										<table class="table table-bordered table-striped FloatWidth Fieldsimg">
										...
										{foreach from=$PROFILE_MODULE->getFields() key=FIELD_NAME item=FIELD_MODEL name="fields"}
											...
											<td style="border-left: 1px solid #DDD !important;">
												...
												<div class="mini-slider-control editViewMiniSlider pull-left CustomMiniSlider" data-locked="{$FIELD_LOCKED}" data-range="{$FIELD_ID}" data-value="{$RECORD_MODEL->getModuleFieldPermissionValue($PROFILE_MODULE, $FIELD_MODEL)}"></div>
												<div class="pull-left">
