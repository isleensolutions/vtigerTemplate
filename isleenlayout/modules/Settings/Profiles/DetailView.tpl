...
<div class="container-fluid">
	...
	<div class="profileDetailView">
		...
		<div class="row-fluid">
			...
			<div class="row-fluid">
				<table class="table table-striped table-bordered FloatWidth">
					<thead>
								...
								<td style="border-left: 1px solid #DDD !important;">
									{if $PROFILE_MODULE->getFields()}
										<div class="row-fluid">
											...
											<span class="col-md-4"><button type="button" data-handlerfor="fields" data-togglehandler="{$TABID}-fields" class="btn btn-mini" style="padding-right: 20px; padding-left: 20px;">
