...
{strip}
	...
	{/foreach}
	<div class="row-fluid padding1per FloatWidth">
		<span class="col-md-4 paddingLeft"><h4>{vtranslate('LBL_COPY_PRIVILEGES_FROM',"Settings:Roles")}</h4></span>
		<span class="col-md-6">
	...
	<table class="table table-striped table-hover table-bordered profilesEditViews">
		<thead>
					...
					<td colspan="6" class="row-fluid" style="padding-left: 5%;padding-right: 5%">
						<div class="row-fluid FloatWidth" data-togglecontent="{$TABID}-fields">
							{if $PROFILE_MODULE->getFields()}
								...
								<table class="table table-hover table-bordered  table-striped FloatWidth">
