		...
		{foreach from=$FIELD_VALUE_MAPPING item=FIELD_MAP}
			<div class="row-fluid conditionRow padding-bottom1per">
				<span class="col-md-4">
					...
					<select name="fieldname" class="select2" style="width: 100%" {if $SELECTED_FIELD_MODEL->isMandatory()} disabled="" {/if} >
				...
				<span class="col-md-3">
					<select name="modulename" class="select2"  style="width:100%" {if ($FIELD_TYPE eq 'picklist' || $FIELD_TYPE eq 'multipicklist')} disabled="" {/if}>
				...
				<span class="fieldUiHolder col-md-4 1">
	...
	{else}
		{if $RELATED_MODULE_MODEL}
			...
			{foreach from=$MANDATORY_FIELD_MODELS item=MANDATORY_FIELD_MODEL}
				...
				<div class="row-fluid conditionRow padding-bottom1per">
					<span class="col-md-4">
						<select name="fieldname" class="select2" disabled=""  style="width:100%">
							<option value="none"></option>
							{foreach from=$RELATED_MODULE_MODEL->getFields() item=FIELD_MODEL}
								{assign var=FIELD_INFO value=$FIELD_MODEL->getFieldInfo()}
					...
					<span class="fieldUiHolder col-md-4 2">
