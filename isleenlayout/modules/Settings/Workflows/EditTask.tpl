...
{strip}
	...
	<div class='modal modelContainer' id="addTaskContainer">
		...
		<form class="form-horizontal" id="saveTask" method="post" action="index.php">
			...
			<div id="scrollContainer">
				<div class="modal-body tabbable">
					...
					<div class="row-fluid padding-bottom1per">
						<div class="col-md-2">
							<input type="checkbox" class="alignTop" name="check_select_date" {if $trigger neq null}checked{/if}/>&nbsp;{vtranslate('LBL_EXECUTE_TASK',$QUALIFIED_MODULE)}
						</div>
						<div class="col-md-10 row-fluid {if $trigger neq null}show {else} hide {/if}" id="checkSelectDateContainer">
							<span class="col-md-3 row-fluid paddingRight">
								<input class="form-control" type="text" name="select_date_days" value="{$days}" data-validation-engine="validate[funcCall[Vtiger_WholeNumber_Validator_Js.invokeValidation]]" style="width:60%;float: left;">&nbsp;
							...
							<span class="col-md-4 marginLeftZero">
