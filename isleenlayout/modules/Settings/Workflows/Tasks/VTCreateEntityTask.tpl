...
-->*}
{strip}
	<div class="row-fluid m-bot15 FloatWidth">
		...
		<div class="col-md-3">
			...
			<select class="chzn-select" id="createEntityModule" name="entity_type" data-validation-engine='validate[required]' style="width:100%">
	...
	<div id="addCreateEntityContainer" style="float:left;">
