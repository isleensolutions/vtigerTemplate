	...
	<div class="row-fluid">
		...
		<div class="row-fluid padding-bottom1per">
			...
			<span class="col-md-5">
				...
				<select name="status" class="chzn-select" style="width:100%">
		...
		<div class="row-fluid padding-bottom1per">
			...
			<span class="col-md-5">
				...
				<select name="eventType" class="chzn-select" style="width:100%">
		...
		<div class="row-fluid padding-bottom1per">
			...
			<span class="col-md-5">
				<select name="assigned_user_id" class="chzn-select" style="width:100%">
		...
		<div class="row-fluid padding-bottom1per">
			...
			<div class="input-append time col-md-3">
				<span class="col-md-12 input-group">
					<input  type="text" class="timepicker-default input-small form-control" value="{$START_TIME}" name="startTime" />
					<span class="cursorPointer input-group-addon">
		...
		<div class="row-fluid padding-bottom1per">
			...
			<span class="col-md-3 row-fluid paddingRight">
				<input class="form-control" type="text" value="{$TASK_OBJECT->startDays}" name="startDays"
					   data-validation-engine="validate[funcCall[Vtiger_WholeNumber_Validator_Js.invokeValidation]]" style="width:60%;float: left;">&nbsp;
				<span class="alignMiddle" style="float: left;padding: 5px;">{vtranslate('LBL_DAYS',$QUALIFIED_MODULE)}</span>
			</span>
			<span class="col-md-3 marginLeftZero">
				<select class="chzn-select" name="startDirection" style="width:100%">
			...
			<span class="col-md-3">
				<select class="chzn-select" name="startDatefield" style="width:100%">
		...
		<div class="row-fluid padding-bottom1per">
			...
			<div class="input-append time col-md-3">
				<span class="col-md-12 input-group">
					<input  type="text" class="timepicker-default input-small form-control" value="{$END_TIME}" name="endTime" />
					<span class="cursorPointer input-group-addon">
						<i class="fa fa-clock-o"></i>
					</span>
				</span>
		...
		<div class="row-fluid padding-bottom1per">
			...
			<span class="col-md-3 marginLeftZero">
				<select class="chzn-select" name="endDirection" style="width:100%">
			...
			<span class="col-md-3">
				<select class="chzn-select" name="endDatefield" style="width:100%">
					{foreach from=$DATETIME_FIELDS item=DATETIME_FIELD}
						...
						<div class="row-fluid">
							...
							<div class="span">
								<div class="input-append date">
									<input type="text" id="calendar_repeat_limit_date" class="dateField input-small form-control" name="calendar_repeat_limit_date" data-date-format="{$dateFormat}" 
