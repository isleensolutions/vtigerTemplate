	...
	<div id="VtEmailTaskContainer">
		<div class="row-fluid">
			<div class="row-fluid padding-bottom1per">
				<span class="col-md-7 row-fluid">
					<span class="col-md-3">{vtranslate('LBL_FROM', $QUALIFIED_MODULE)}</span>
					<span class="col-md-9">
						<input data-validation-engine='validate[]' name="fromEmail" class="form-control fields" type="text" value="{$TASK_OBJECT->fromEmail}" />
					</span>
				</span>
				<span class="col-md-5">
			...
			<div class="row-fluid padding-bottom1per">
				<span class="col-md-7 row-fluid">
					<span class="col-md-3">{vtranslate('LBL_TO',$QUALIFIED_MODULE)}<span class="redColor">*</span></span>
					<span class="col-md-9">
						<input data-validation-engine='validate[required]' name="recepient" class="form-control fields" type="text" value="{$TASK_OBJECT->recepient}" />
					</span>
				</span>
				<span class="col-md-5">
			...
			<div class="row-fluid padding-bottom1per {if empty($TASK_OBJECT->emailcc)}hide {/if}" id="ccContainer">
				<span class="col-md-7 row-fluid">
					<span class="col-md-3">{vtranslate('LBL_CC',$QUALIFIED_MODULE)}</span>
					<span class="col-md-9">
						<input class="form-control" type="text" name="emailcc" value="{$TASK_OBJECT->emailcc}" />
					</span>
				</span>
				<span class="col-md-5">
			...
			<div class="row-fluid padding-bottom1per {if empty($TASK_OBJECT->emailbcc)}hide {/if}" id="bccContainer">
				<span class="col-md-7 row-fluid">
					<span class="col-md-3">{vtranslate('LBL_BCC',$QUALIFIED_MODULE)}</span>
					<span class="col-md-9">
						<input class="form-control" type="text" name="emailbcc" value="{$TASK_OBJECT->emailbcc}" />
					</span>
				</span>
				<span class="col-md-5">
					<select class="task-fields" data-placeholder='{vtranslate('LBL_SELECT_OPTIONS',$QUALIFIED_MODULE)}' style="min-width: 300px">
			...
			<div class="row-fluid padding-bottom1per">
				<span class="col-md-7 row-fluid">
					<span class="col-md-3">{vtranslate('LBL_SUBJECT',$QUALIFIED_MODULE)}<span class="redColor">*</span></span>
					<span class="col-md-9">
						<input data-validation-engine='validate[required]' name="subject" class="form-control fields" type="text" name="subject" value="{$TASK_OBJECT->subject}" id="subject"/>
					</span>
				</span>
				<span class="col-md-5">
					<select style="min-width: 300px" class="task-fields chzn-select" data-placeholder={vtranslate('LBL_SELECT_OPTIONS',$QUALIFIED_MODULE)}>
			...
			<div class="row-fluid padding-bottom1per">
				<span class="col-md-6 row-fluid">
					<span style="margin-top: 20px" class="col-md-4">{vtranslate('LBL_ADD_FIELD',$QUALIFIED_MODULE)}</span>&nbsp;&nbsp;
					<span class="col-md-8">
				...
				<span class="col-md-6 row-fluid">
					<span style="margin-top: 20px" class="col-md-3">{vtranslate('LBL_ADD_TIME',$QUALIFIED_MODULE)}</span>&nbsp;&nbsp;
					<span class="col-md-9">
