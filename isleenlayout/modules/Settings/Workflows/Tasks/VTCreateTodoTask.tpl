	...
	<div class="row-fluid">
		...
		<div class="row-fluid padding-bottom1per">
			...
			<span class="col-md-5">
				...
				<select name="priority" class="chzn-select" style="width:100%">
		...
		<div class="row-fluid padding-bottom1per">
			...
			<div class="input-append input-group time col-md-3" style="padding:0 15px;">
			...
			{/if}
				<input  type="text" class="timepicker-default input-small form-control" value="{$TIME}" name="time" />
		...
		<div class="row-fluid padding-bottom1per">
			<span class="col-md-2">{vtranslate('LBL_DUE_DATE',$QUALIFIED_MODULE)}</span>
			<span class="col-md-2 row-fluid paddingRight">
				<input class="form-control" type="text" name="days" value="{$TASK_OBJECT->days}" style="width:60%;float: left;">&nbsp;
			...
			<span class="col-md-3" style="vertical-align: super">({vtranslate('LBL_THE_SAME_VALUE_IS_USED_FOR_START_DATE',$QUALIFIED_MODULE)})</span>
		</div>
		<div class="row-fluid">
			<span class="col-md-2 paddingRight">{vtranslate('LBL_SEND_NOTIFICATION',$QUALIFIED_MODULE)}</span>
			<div class="col-md-6">
