	...
	getPopUp : function(container) {
		...
		container.on('click','.getPopupUi',function(e) {
			...
			if(fieldValueElement.hasClass('date')){
				...
				var clonedDateElement = '<input type="text" class="row-fluid dateField fieldValue col-md-4" value="'+value+'" data-date-format="'+dataFormat+'" data-input="true" >'
				...
				var clonedTimeElement = '<input type="text" class="row-fluid timepicker-default fieldValue col-md-4" value="'+value+'" data-input="true" >'
				...
				var clonedBooleanElement = '<input type="checkbox" class="row-fluid fieldValue col-md-4" value="'+value+'" data-input="true" >';
