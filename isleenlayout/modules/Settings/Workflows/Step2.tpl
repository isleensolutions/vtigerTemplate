...
{strip}
	<form name="EditWorkflow" action="index.php" method="post" id="workflow_step2" class="form-horizontal" >
		...
		<input type="hidden" name="filtersavedinnew" value="{$WORKFLOW_MODEL->get('filtersavedinnew')}" />
			<div class="row-fluid padding1per contentsBackground FloatWidth m-bot15" style="border:1px solid #ccc;">
			...
			<div class="pull-right">
				...
				<button class="btn btn-success" type="submit" style="margin-right:5px;"><strong>{vtranslate('LBL_NEXT', $QUALIFIED_MODULE)}</strong></button>
