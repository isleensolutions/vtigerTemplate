...
{strip}
    <div class="container-fluid" id="layoutEditorContainer">
        ...
        <div class="widget_header row-fluid">
            ...
            <div class="col-md-4">
                <div class="pull-right col-md-12 paddingLeftRight" style="margin-top:15px">
                    <select class="select2 col-md-12 paddingLeftRight" name="layoutEditorModules">
        ...
        <div class="contents tabbable">
            <ul class="nav nav-tabs layoutTabs massEditTabs" style="margin:15px 0;">
                ...
                <div class="tab-pane active" id="detailViewLayout">
                    ...
                    <div id="moduleBlocks">
                        {foreach key=BLOCK_LABEL_KEY item=BLOCK_MODEL from=$BLOCKS}
                            ...
                            <div id="block_{$BLOCK_ID}" class="editFieldsTable block_{$BLOCK_ID} marginBottom10px border1px {if $IS_BLOCK_SORTABLE} blockSortable{/if}" data-block-id="{$BLOCK_ID}" data-sequence="{$BLOCK_MODEL->get('sequence')}" style="border-radius: 4px 4px 0px 0px;background: white;float:left;width:100%;">
                                <div class="row-fluid layoutBlockHeader" style="float:left;width:100%;">
                                    <div class="blockLabel col-md-6 padding10 marginLeftZero">
                                ...
                                <div class="blockFieldsList {if $SELECTED_MODULE_MODEL->isFieldsSortableAllowed($BLOCK_LABEL_KEY)}blockFieldsSortable {/if} row-fluid" style="padding:5px;min-height: 27px;float:left;width:100%;">
                                                ...
                                                <li>
                                                    <div class="opacity editFields marginLeftZero border1px" data-block-id="{$BLOCK_ID}" data-field-id="{$FIELD_MODEL->get('id')}" data-sequence="{$FIELD_MODEL->get('sequence')}">
                                                        <div class="row-fluid padding1per">
                                                            ...
                                                            <div class="col-md-10 marginLeftZero" style="word-wrap: break-word;">
                            ...
                            {if $FIELD_MODEL->isCustomField() eq 'true'}
                                <a href="javascript:void(0)" class="deleteCustomField" data-field-id="{$FIELD_MODEL->get('id')}">
                                    <i class="fa fa-trash-o alignMiddle" title="{vtranslate('LBL_DELETE', $QUALIFIED_MODULE)}"></i>
                                </a>
                            {/if}
                        </span>
                    </div>
    ...
    <div class="marginLeftZero border1px" data-field-id="" data-sequence="">
        ...
        <div class="col-md-11 marginLeftZero" style="word-wrap: break-word;">
            ...
            <span class="btn-group pull-right actions">
                ...
                {/if}
                <a href="javascript:void(0)" class="deleteCustomField" data-field-id=""><i class="fa fa-trash-o alignMiddle" title="{vtranslate('LBL_DELETE', $QUALIFIED_MODULE)}"></i></a>
            </span>
        </div>
    </div>
</div>
...
<div class="modal addBlockModal hide" style="display:block;">
    <div class="modal-header contentsBackground">
            ...
            <div class="control-group FloatWidth m-bot15">
                ...
                <div class="controls col-md-6">
                    <span class="row-fluid">
                        <select class="FloatWidth" name="beforeBlockId">
    ...
    <form class="form-horizontal createCustomFieldForm">
        <div class="modal-body marginLeftRight20px">
            <div class="control-group FloatWidth m-bot15">
                ...
                <div class="controls col-md-6">
                    <span class="row-fluid">
                        <select class="fieldTypesList FloatWidth" name="fieldType">
            ...
            <div class="control-group FloatWidth m-bot15">
                ...
                <div class="controls col-md-6">
                    <input type="text" class="form-control" maxlength="50" name="fieldLabel" value="" data-validation-engine="validate[required, funcCall[Vtiger_Base_Validator_Js.invokeValidation]]"
                           data-validator={Zend_Json::encode([['name'=>'FieldLabel']])} />
                </div>
            </div>
            <div class="control-group supportedType lengthsupported FloatWidth m-bot15">
                <span class="control-label col-md-6">
                    <span class="redColor">*</span>&nbsp;
                    {vtranslate('LBL_LENGTH', $QUALIFIED_MODULE)}
                </span>
                <div class="controls col-md-6">
                    <input type="text" class="form-control" name="fieldLength" value="" data-validation-engine="validate[required, funcCall[Vtiger_Base_Validator_Js.invokeValidation]]" />
                </div>
            </div>
