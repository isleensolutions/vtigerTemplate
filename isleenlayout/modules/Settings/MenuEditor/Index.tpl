...
{strip}
	<div class="container-fluid" id="menuEditorContainer">
		<div class="widget_header row-fluid">
			<div class="col-md-8"><h3>{vtranslate('LBL_MENU_EDITOR', $QUALIFIED_MODULE)}</h3></div>
		</div>
		<hr>
		...
		<div class="contents">
			<form name="menuEditor" action="index.php" method="post" class="form-horizontal" id="menuEditor">
				...
				<div class="row-fluid paddingTop20px CustomMenuEditor">
					{assign var=SELECTED_MODULE_IDS value=array()}
					
					<select data-placeholder="{vtranslate('LBL_ADD_MENU_ITEM',$QUALIFIED_MODULE)}" id="menuListSelectElement" class="select2 FloatWidth" multiple="" data-validation-engine="validate[required]" >
                ...
                <div class="row-fluid paddingTop20px FloatWidth">
                    <div class=" col-md-6">
