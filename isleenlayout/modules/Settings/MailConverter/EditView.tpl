...
{strip}
    ...
    <div class="modal modelContainer MailConverter" style="overflow: hidden; height: 385px;">        
        ...
        <form class="form-horizontal" id="mailBoxEditView" style="height:300px;overflow: hidden;">
        <div class="modal-body CreateMailBox">  
            <div class="marginLeftRight20px">  
                ...
                <div class="control-group FloatWidth m-bot15">
                    ...
                    <div class="controls col-md-7">
                        ...
                        <input type="password" class="form-control" name="{$FIELD_MODEL->getName()}" {if $RECORD_EXISTS} value="{$RECORD_MODEL->get($FIELD_NAME)}" {/if}
                        ...
                        {elseif $FIELD_DATA_TYPE eq 'picklist'}
                            ...
                            {/if}
                            <select name="{$FIELD_MODEL->getName()}" class="select2 FloatWidth"
                        ...
                        {elseif $FIELD_DATA_TYPE eq 'radio'}
                            ...
                            {/foreach}
                        {else}
                        <input type="text" class="form-control" name="{$FIELD_MODEL->getName()}" 
