...
-->*}
{strip}
	<span id="shortcut_{$SETTINGS_SHORTCUT->getId()}" data-actionurl="{$SETTINGS_SHORTCUT->getPinUnpinActionUrl()}" class="col-md-5 contentsBackground well cursorPointer moduleBlock marginRight10px" data-url="{$SETTINGS_SHORTCUT->getUrl()}" style="margin-right: 2%;cursor: pointer;">
