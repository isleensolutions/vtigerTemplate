...
jQuery.Class("Vtiger_List_Js",{
	...
	*/
	...
	/*
	 * Added this  nicescrollbar for massEdit modal
	 */	
	registerSlimScrollMassEdit : function() {
		$(".massEditContent").niceScroll({styler:"fb",cursorcolor:"#e8403f", cursorwidth: '6', cursorborderradius: '10px', background: '#404040', spacebarenabled:false, cursorborder: ''});
	},
