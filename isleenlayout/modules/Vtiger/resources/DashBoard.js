		...
		if(mode == 'open') {
			AppConnector.request(urlParams).then(
				function(data){
					...
					jQuery(".dashboardWidgetContent.panel-body").niceScroll({styler:"fb",cursorcolor:"#e8403f", cursorwidth: '6', cursorborderradius: '10px', background: '#404040', spacebarenabled:false, cursorborder: ''});
