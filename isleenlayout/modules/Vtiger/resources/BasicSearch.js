...
jQuery.Class('Vtiger_BasicSearch_Js',{},{
	...
	showSearchResults : function(data){
		...
		var postLoad = function(data) {
			...
			jQuery(".globalSearchBody").niceScroll({styler:"fb",cursorcolor:"#e8403f", cursorwidth: '6', cursorborderradius: '10px', background: '#404040', spacebarenabled:false, cursorborder: ''});
			blockMsg.position({
				my: "left bottom",
				at: "left bottom",
