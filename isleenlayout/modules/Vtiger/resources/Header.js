...
jQuery.Class("Vtiger_Header_Js", {
    ...
    getQuickCreateForm: function(url, moduleName, params) {
        ...
        AppConnector.request(requestParams).then(function(data) {
            ...
            // Added this for nicescrollbar			
            $(".quickCreateContent").niceScroll({styler:"fb",cursorcolor:"#e8403f", cursorwidth: '6', cursorborderradius: '10px', background: '#404040', spacebarenabled:false, cursorborder: ''});
        });
        return aDeferred.promise();
    },
...
//        } 
    ...
    registerEvents: function() {
      ...
      //  });
         ...
         jQuery('#basicSearchModulesList_chzn').find('.chzn-results').niceScroll({
            styler:"fb",
            cursorcolor:"#e8403f", 
            cursorwidth: '6', 
            cursorborderradius: '', 
        ...
        jQuery(".mainContainer > .col-md-2").css('height', contentsHeight);
    }
});
