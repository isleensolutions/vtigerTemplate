...
Vtiger_Widget_Js('Vtiger_History_Widget_Js', {}, {
	...
	postLoadWidget: function() {
		...
		var history = gridster.find('ul li[data-name = History]').addClass('History');
		var topPotentials = gridster.find('ul li[data-name = TopPotentials]').addClass('TopPotentials');
		var calendarActivities = gridster.find('ul li[data-name = CalendarActivities]').addClass('CalendarActivities');
		var groupedBySalesPerson = gridster.find('ul li[data-name = GroupedBySalesPerson]').addClass('GroupedBySalesPerson');
...
Vtiger_Widget_Js('Vtiger_Funnel_Widget_Js',{},{
	...
	loadChart : function() {
		...
		this.getPlotContainer(false).jqplot([dataInfo],  {
			seriesColors:[ '#59ace2','#8175c7', '#e4ba00', '#ec6459', '#41cac0', '#a9d85e'],
			seriesDefaults: {
