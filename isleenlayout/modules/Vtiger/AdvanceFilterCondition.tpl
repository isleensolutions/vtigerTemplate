...
-->*}
{strip}
<div class="row conditionRow m-bot15">
	<span class="col-lg-4">
	...
	<span class="col-lg-4 fieldUiHolder">
		<input name="{if $SELECTED_FIELD_MODEL}{$SELECTED_FIELD_MODEL->get('name')}{/if}" data-value="value" class="row-fluid form-control" type="text" value="{$CONDITION_INFO['value']|escape}" />
	</span>
	<span class="hide">
	 ...
	 <span class="col-lg-1 CustomPosition">
		<i class="deleteCondition fa fa-trash-o alignMiddle" title="{vtranslate('LBL_DELETE', $MODULE)}"></i>
	</span>
</div>
{/strip}