...
<div class="panel-body">
	<div class="row-fluid">
		...
		<span class="col-md-5 horizontalLeftSpacingForSummaryWidgetHeader paddingLeftRight">
			...
			<ul class="unstyled">
				<li>
					<div class="row-fluid" id="documentRelatedRecord">
						<span class="col-md-7 textOverflowEllipsis paddingLeftRight">
						...
						<span class="col-md-5 textOverflowEllipsis paddingLeftRight" id="DownloadableLink">
