...
{/foreach}
<div id="massEditContainer" class='modal modelContainer modalmasseditForm'>
	...
	<form class="form-horizontal" id="massEdit" name="MassEdit" method="post" action="index.php">
		...
		<div name='massEditContent' id="massEditContents">
					...
					<div class="tab-pane {if $smarty.foreach.blockIterator.iteration eq 1}active{/if}" id="block_{$smarty.foreach.blockIterator.iteration}">
						<table class="massEditTable table table-bordered">
							...
							<tr>
								...
								<td class="fieldValue col-md-3" {if $FIELD_MODEL->getFieldDataType() eq 'boolean'} style="width:25%" {/if} {if $FIELD_MODEL->get('uitype') eq '19'} colspan="3" {assign var=COUNTER value=$COUNTER+1} {/if}>
