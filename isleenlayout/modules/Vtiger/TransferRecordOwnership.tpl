        ...
        <form class="form-horizontal" id="changeOwner" name="changeOwner" method="post" action="index.php">
            <div class="modal-body tabbable">
                <div class="control-group form-group">
                    <div class="control-label col-md-6">{vtranslate('LBL_SELECT_RELATED_MODULES',$MODULE)}</div>
                    <div class="controls col-md-6">
                        <select class="select2-container columnsSelect" id="related_modules" data-validation-engine="validate[required]" data-placeholder="{vtranslate('LBL_SELECT_RELATED_MODULES',$MODULE)}" multiple="" name="related_modules[]">
                ...
                <div class="control-group form-group">
                    <div class="control-label col-md-6">{vtranslate('LBL_ASSIGNED_TO', $MODULE)}</div>
                    <div class="controls col-md-6">
