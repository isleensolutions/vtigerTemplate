...
<div class="input-append time input-group calendar" style="width:130px">
    <input id="{$MODULE}_editView_fieldName_{$FIELD_MODEL->get('name')}" type="text" data-format="{$TIME_FORMAT}" class="timepicker-default input-small form-control" value="{$FIELD_VALUE}" name="{$FIELD_MODEL->getFieldName()}"
    ...
    <span class="cursorPointer input-group-addon" style="float: none;margin-top: 0;">
