...
{assign var="dateFormat" value=$USER_MODEL->get('date_format')}
	<input id="{$MODULE}_editView_fieldName_{$FIELD_MODEL->get('name')}" type="text" class="input-large dateTimeField form-control" name="{$FIELD_MODEL->getFieldName()}" data-date-format="{$dateFormat}"
