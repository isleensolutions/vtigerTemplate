...
<div class="fileUploadContainer">
	{if $IS_EXTERNAL_LOCATION_TYPE}
		<div class="fileupload fileupload-new" data-provides="fileupload">
			<span class="btn btn-white btn-file" style="float: left;">
				...
				<input type="file" class="default input-large {if $FIELD_MODEL->isNameField()}nameField{/if}" data-validation-engine="validate[{if $FIELD_MODEL->isMandatory() eq true}required,{/if}funcCall[Vtiger_Base_Validator_Js.invokeValidation]]" name="{$FIELD_MODEL->getFieldName()}"
	...
	<div class="uploadedFileDetails {if $IS_EXTERNAL_LOCATION_TYPE}hide{/if}">
		...
		<div class="uploadFileSizeLimit redColor FloatWidth">
