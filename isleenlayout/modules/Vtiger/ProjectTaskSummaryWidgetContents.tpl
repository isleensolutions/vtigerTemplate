...
<div class="panel-body">
	<div class="row-fluid">		
		<span class="col-md-8 paddingLeftRight">
	...
	{foreach item=RELATED_RECORD from=$RELATED_RECORDS}
		<div class="recentActivitiesContainer">
			<ul class="unstyled">
				<li>
					<div class="row-fluid">
						<span class="col-md-8 paddingLeftRight textOverflowEllipsis">
						...
						<span class="col-md-4 horizontalLeftSpacingForSummaryWidgetContents paddingLeftRight">
