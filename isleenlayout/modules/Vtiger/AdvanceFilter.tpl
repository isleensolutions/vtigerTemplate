...
<div class="filterContainer FloatWidth">
	...
	<div class="allConditionContainer conditionGroup contentsBackground">
		<section class="panel col-md-12 paddingLeftRight">
		<header class="panel-heading">
			<span>{vtranslate('LBL_ALL_CONDITIONS',$MODULE)}</span>
			&nbsp;
			<span>({vtranslate('LBL_ALL_CONDITIONS_DESC',$MODULE)})</span>
		</header>
		<div class="contents panel-body">
			...
			<br>
			<div class="addCondition col-md-12">
	...
	<div class="anyConditionContainer conditionGroup contentsBackground">
		<section class="panel col-md-12 paddingLeftRight ">
		<header class="panel-heading">
			<span>{vtranslate('LBL_ANY_CONDITIONS',$MODULE)}</span>
			&nbsp;
			<span>(<em>{vtranslate('LBL_ANY_CONDITIONS_DESC',$MODULE)}</em>)</span>
		</header>
		<div class="contents panel-body">
			<div class="conditionList">
