...
{if $WIZARD_STEP eq 'step1'}
	<div id="minilistWizardContainer" class='modelContainer'>
		<div class="modal-header contentsBackground  col-md-12">
            <button data-dismiss="modal" class="close" title="{vtranslate('LBL_CLOSE')}">&times;</button>
			<h3 id="massEditHeader">{vtranslate('LBL_MINI_LIST', $MODULE)} {vtranslate($MODULE, $MODULE)}</h3>
		</div>
		<form class="form-horizontal  col-md-12" method="post" action="javascript:;">
			...
			<table class="table table-bordered">
				<tbody>
					<tr>
						...
						<td class="fieldValue">
							<select class="col-md-12" name="module">
								<option></option>
					...
					<tr>
						...
						<td class="fieldValue">
							<select class="col-md-12" name="filterid">
								<option></option>
							</select>
						</td>
					</tr>
					<tr>
						...
						<td class="fieldValue">
							<select class="col-md-12" name="fields" size="2" multiple="true">
								<option></option>
							</select>
						</td>
					</tr>
