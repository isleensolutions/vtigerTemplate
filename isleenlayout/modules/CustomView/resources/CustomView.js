...
var Vtiger_CustomView_Js = {
	...
	loadFilterView : function(url) {
		...
		AppConnector.request(url).then(
			function(data){
				app.hideModalWindow();
				var contents = jQuery(".listViewPageDiv").html(data);
	...
	getContentsContainer : function() {
		if(Vtiger_CustomView_Js.contentsCotainer == false) {
			Vtiger_CustomView_Js.contentsCotainer = jQuery('div.listViewPageDiv');
		}
	...
	arrangeSelectChoicesInOrder : function() {
		...
		var selectedOptions = coulmnListSelectElement.find('option:selected');console.info(contentsContainer);
