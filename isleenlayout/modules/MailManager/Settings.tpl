<div class="editViewContainer FloatWidth">
	<form action="javascript:void(0);" method="POST" id="EditView" class="FloatWidth">
		<div class="widget_header row-fluid">
			<h3>{vtranslate('JSLBL_Settings',$MODULE)}</h3>
		</div>
		<hr>
		<table class="table blockContainer showInlineTable">
			<tbody>
				<tr>
				...
				<tr class="FloatWidth">
					<td class="fieldLabel col-md-3">
						<label class="muted pull-right marginRight10px">{vtranslate('LBL_SELECT_ACCOUNT_TYPE',$MODULE)}</label>
					</td>
					<td class="fieldValue narrowWidthType  col-md-9">
						<select id="_mbox_helper" class="small form-control" onchange="MailManager.handle_settings_confighelper(this);" style="width:50%">
		...
		<table class="table  blockContainer showInlineTable">
            ...
            <tr>
                ...
                <td class="fieldValue narrowWidthType" nowrap style="width: 75%;">
                    <input class="form-control" name="_mbox_server" value="{$MAILBOX->server()}" data-validation-engine="validate[required]]" type="text" style="width: 60%" class="detailedViewTextBox" onblur="this.className='detailedViewTextBox'" onfocus="this.className='detailedViewTextBoxOn'">
            ...
            <tr>
                ...
                <td class="fieldValue narrowWidthType" nowrap>
                    <input class="form-control" name="_mbox_user" id="_mbox_user" value="{$MAILBOX->username()}" type="text" style="width: 60%" class="detailedViewTextBox" onblur="this.className='detailedViewTextBox'" onfocus="this.className='detailedViewTextBoxOn'">
            ...
            <tr>
                ...
                <td class="fieldValue narrowWidthType" nowrap>
                    <input class="form-control" name="_mbox_pwd" id="_mbox_pwd" value="{$MAILBOX->password()}" type="password" style="width: 60%" class="detailedViewTextBox" onblur="this.className='detailedViewTextBox'" onfocus="this.className='detailedViewTextBoxOn'">
		...
		<table class="table blockContainer showInlineTable">
			<tr>
				...
				<td class="fieldValue narrowWidthType" nowrap style="width: 75%;">{$MAILBOX->protocol()}
        ...
        <table class="table blockContainer showInlineTable">
            <tr>
                ...
                <td class="fieldValue narrowWidthType" nowrap  style="width: 75%;">
                    <select name="_mbox_refresh_timeout" class="form-control"  style="width:30%">
            ...
            <tr>
                ...
                <td colspan=3  width="75%">
                    ...
                    {if $MAILBOX && $MAILBOX->exists()}
                        ...
                        <a href="javascript:;" class="cancelLink" onclick="MailManager.close_settings();">{vtranslate('LBL_CANCEL_BUTTON_LABEL',$MODULE)}</a>
                    {/if}
                </td>
            </tr>
        </table>
