...
-->*}
{strip}
<div id="massEditContainer contentsBackground" class='modelContainer Change_Owner'>
	<div class="modal-header">
        <button type="button" class="close " data-dismiss="modal" aria-hidden="true">&times;</button>
		<h3 id="massEditHeader">{vtranslate('LBL_CHANGE_OWNER', $MODULE)}</h3>
	</div>
	<form class="form-horizontal calendarMassEdit" id="massEdit" name="MassEdit" method="post" action="index.php" style="height: auto;">
