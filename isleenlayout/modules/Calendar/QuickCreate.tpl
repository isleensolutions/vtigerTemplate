{strip}
    ...
    <div class="modal modelContainer CalendarAddEvent">
			...
			<div class="modal-body tabbable" style="padding:0px">
				<ul class="nav nav-pills" style="margin:5px 0 0 5px;padding-left:5px">
					<li class="active">
				...
				<div class="tab-content overflowVisible">
					...
					<div class="{$MODULE_NAME}QuikcCreateContents_{$RAND_NUMBER} tab-pane {if $MODULE_NAME eq 'Events'} active in {/if}fade">
						...
						<div class="quickCreateContent formwidth">
							<div style='margin:5px'>
								<table class="massEditTable table table-bordered">
									...
									<tr>
										...
										{/if}
										<td class="fieldLabel alignMiddle col-md-3">
										...
										<td class="fieldValue col-md-3" {if $FIELD_MODEL->get('uitype') eq '19'} colspan="3" {assign var=COUNTER value=$COUNTER+1} {/if}>
		    ...
		    <div class="modal-footer quickCreateActions">
							...
							{/if}
								...
								<button class="btn btn-success" type="submit" id="saveButton"><strong>{vtranslate('LBL_SAVE', $MODULE)}</strong></button>
								<a class="btn btn-default" id="goToFullForm" type="button" href="{$EDIT_VIEW_URL}"><strong>{vtranslate('LBL_GO_TO_FULL_FORM', $MODULE)}</strong></a>
				</div>
</div>
{/strip}
