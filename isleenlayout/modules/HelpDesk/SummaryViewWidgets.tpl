				...
				<div class="summaryWidgetContainer">
					<div class="widgetContainer_documents" data-url="{$DOCUMENT_WIDGET_MODEL->getUrl()}" data-name="{$DOCUMENT_WIDGET_MODEL->getLabel()}">
						<div class="widget_header row-fluid">
							...
							<span class="col-md-9 margin0px"><h4 class="textOverflowEllipsis">{vtranslate($DOCUMENT_WIDGET_MODEL->getLabel(),$MODULE_NAME)}</h4></span>
							<span class="col-md-3">
								<span class="pull-right">
				...
				<div class="summaryWidgetContainer">
					<div class="widgetContainer_updates" data-url="{$UPDATES_WIDGET_MODEL->getUrl()}" data-name="{$UPDATES_WIDGET_MODEL->getLabel()}">
						<div class="widget_header row-fluid">
							...
							<span class="col-md-9 margin0px"><h4 class="textOverflowEllipsis">{vtranslate($UPDATES_WIDGET_MODEL->getLabel(),$MODULE_NAME)}</h4></span>
							<span class="col-md-3">
								<span class="pull-right">
