				...
				<div>
					...
					<div>
						<div>
							...
							<div class='tab-content contentsBackground' style="height: auto; border: 1px solid rgb(204, 204, 204); padding: 4%; float: left; width: 100%; border:1px solid #ccc;">
								<br>
								...
								<div class='row-fluid alert-info well' style="position: relative; width: 95%; float: left; top: 46px;">
