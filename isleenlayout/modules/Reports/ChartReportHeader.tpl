    ...
    <div class="container-fluid">
        <div class="row-fluid reportsDetailHeader">
            ...
            <div class="reportHeader row-fluid">
                ...
                <div class='span4'>
                    <div class="btn-toolbar pull-right" style="margin: 10px;">
                        {if $REPORT_MODEL->isEditable() eq true}
                            <div class="btn-group">
                                <button onclick='window.location.href="{$REPORT_MODEL->getEditViewUrl()}"' type="button" class="btn btn-primary">
                                    <strong>{vtranslate('LBL_CUSTOMIZE',$MODULE)}</strong>&nbsp;
                                    <i class="icon-pencil"></i>
                                </button>
                            </div>
                        {/if}
                        <div class="btn-group"><button type="button" class="btn btn-primary" title="Pin Chart To DashBoard"> &nbsp; <i class="fa fa-bell-o"></i> </button></div>
                        <div class="btn-group">
                            <button onclick='window.location.href="{$REPORT_MODEL->getDuplicateRecordUrl()}"' type="button" class="btn btn-primary">
			...
			<div class="well">
				<form name='chartDetailForm' id='chartDetailForm'>
					...
					<div class="row-fluid col-md-12 paddingLeftRight">
						<div class='col-md-12'>
							<div class='row-fluid'>
								<span class="col-md-5">
									...
									<div class="row-fluid">
										<select id='groupbyfield' name='groupbyfield' class="" data-validation-engine="validate[required]" style='min-width:300px;'></select>
									</div>
								</span>
								<span class="col-md-5">
									<div><span>{vtranslate('LBL_SELECT_DATA_FIELD', $MODULE)}</span><span class="redColor">*</span></div><br>
									<div class="row-fluid">
										<select id='datafields' name='datafields[]' class="" data-validation-engine="validate[required]" style='min-width:300px;'>
									</select></div>
								</span>
							</div>
							<br>
						...
						<br>
						<div class='col-md-12' style="margin:20px 15px;">
							...
							<button class="btn btn-success" name="modify_condition" data-val="{$filterConditionNotExists}">
						...
						<br>
						<div id='filterContainer' class='{if $filterConditionNotExists eq true} col-md-12 {/if}' style="display:none;">
					...
					<div class="row-fluid textAlignCenter col-md-12 paddingLeftRight">
