...
<div class="listViewEntriesDiv contents-bottomscroll">
	...
	<table class="table table-hover table-inbox listViewEntriesTable">
		<thead>
					...
					{if $LISTVIEW_HEADER@last}
						...
						<div class="pull-right actions">
							<span class="actionImages">
								<a href='{$LISTVIEW_ENTRY->getEditViewUrl()}'><i title="{vtranslate('LBL_EDIT', $MODULE)}" class="fa fa-pencil alignMiddle"></i></a>&nbsp;
