...
{strip}
	<form class="form-horizontal recordEditView" id="report_step2" method="post" action="index.php">
		...
		<div class="well padding1per contentsBackground ">
			<div class="row-fluid block col-md-12 marginbottom10px">
				<div class="span marginbottom10px"><strong>{vtranslate('LBL_SELECT_COLUMNS',$MODULE)}({vtranslate('LBL_MAX',$MODULE)} 25)</strong></div>
				<div class="row-fluid span col-md-12 CustomReportStep2">
					<select data-placeholder="{vtranslate('LBL_ADD_MORE_COLUMNS',$MODULE)}" id="reportsColumnsList" class="select2-container columns form-control" multiple="">
			...
			<div class="row-fluid block col-md-12 marginbottom10px">
				<div class="row-fluid col-md-12 marginbottom10px paddingLeft">
				...
				{foreach key=SELECTED_SORT_FIELD_KEY item=SELECTED_SORT_FIELD_VALUE from=$SELECTED_SORT_FIELDS}
					<div class="row-fluid col-md-12 sortFieldRow marginbottom10px paddingLeft">
			...
			<div class="row-fluid block col-md-12 marginbottom10px">
				<div class="span marginbottom10px"><strong>{vtranslate('LBL_CALCULATIONS',$MODULE)}</strong></div>
				<div class="col-md-11">
