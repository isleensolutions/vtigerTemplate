{strip}
    ...
    <div class="col-md-4">
        ...
        <div class="col-md-5 btn-group pull-right paddingLeftRight">
            <button class="btn" id="relatedListPreviousPageButton" {if !$PAGING->isPrevPageExists()} disabled="disabled" {/if} type="button"><span class="fa fa-chevron-left"></span></button>
            ...
            <button class="btn" id="relatedListNextPageButton" {if (!$PAGING->isNextPageExists()) or ($PAGE_COUNT eq 1)} disabled="disabled" {/if} type="button"><span class="fa fa-chevron-right"></span></button>
        </div>
    </span>
    </span>
</div>
